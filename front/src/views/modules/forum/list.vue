            ...
            <el-table :data="forumData" height="250">
                ...
                <el-table-column label="身份">
                    <template slot-scope="scope">
                        ...
                        <span v-if="scope.row.meirongshiId">
                            美容师
                        </span>
...
|| (sessionTable == 'meirongshi' && scope.row.meirongshiId ==userId)
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/meifaguanli/upload/forumMuBan.xls"
                        >批量导入论坛数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('forum','导入导出')"
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        data.data.list.forEach(el=>{
                            ...
                            forum.meirongshiId = el.meirongshiId;//---
                            forum.meirongshiName = el.meirongshiName;
                            forum.meirongshiPhone = el.meirongshiPhone;
                            forum.meirongshiEmail = el.meirongshiEmail;
                            forum.meirongshiNewMoney = el.meirongshiNewMoney;
                            forum.meirongshiPhoto = el.meirongshiPhoto;
                            forum.meirongshiPrice = el.meirongshiPrice;
                            forum.meirongshiXingjiTypes = el.meirongshiXingjiTypes;
                            forum.meirongshiContent = el.meirongshiContent;
                            forum.createTime = el.createTime;
