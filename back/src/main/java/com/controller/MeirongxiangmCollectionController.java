...
@RestController
@Controller
@RequestMapping("/meirongxiangmCollection")
public class MeirongxiangmCollectionController {
    ...
    */
    ...
    public R update(@RequestBody MeirongxiangmCollectionEntity meirongxiangmCollection, HttpServletRequest request) throws NoSuchFieldException, ClassNotFoundException, IllegalAccessException, InstantiationException {
        logger.debug("update方法:,,Controller:{},,meirongxiangmCollection:{}",this.getClass().getName(),meirongxiangmCollection.toString());
        MeirongxiangmCollectionEntity oldMeirongxiangmCollectionEntity = meirongxiangmCollectionService.selectById(meirongxiangmCollection.getId());//查询原先数据
...
//            meirongxiangmCollection.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
            ...
            meirongxiangmCollectionService.updateById(meirongxiangmCollection);//根据id更新
            return R.ok();
    }
    ...
    */
    ...
    public R delete(@RequestBody Integer[] ids, HttpServletRequest request){
        ...
        List<MeirongxiangmCollectionEntity> oldMeirongxiangmCollectionList =meirongxiangmCollectionService.selectBatchIds(Arrays.asList(ids));//要删除的数据
        meirongxiangmCollectionService.deleteBatchIds(Arrays.asList(ids));
    ...
    public R save( String fileName, HttpServletRequest request){
        ...
        try {
            List<MeirongxiangmCollectionEntity> meirongxiangmCollectionList = new ArrayList<>();//上传的东西
                ...
                if(!".xls".equals(suffix)){
                    ...
                    if(!file.exists()){
                        ...
                        for(List<String> data:dataList){
                            //循环
                            MeirongxiangmCollectionEntity meirongxiangmCollectionEntity = new MeirongxiangmCollectionEntity();
//                            meirongxiangmCollectionEntity.setMeirongxiangmId(Integer.valueOf(data.get(0)));   //美容项目 要改的
//                            meirongxiangmCollectionEntity.setYonghuId(Integer.valueOf(data.get(0)));   //用户 要改的
//                            meirongxiangmCollectionEntity.setMeirongxiangmCollectionTypes(Integer.valueOf(data.get(0)));   //类型 要改的
//                            meirongxiangmCollectionEntity.setInsertTime(date);//时间
//                            meirongxiangmCollectionEntity.setCreateTime(date);//时间
                            meirongxiangmCollectionList.add(meirongxiangmCollectionEntity);
                        ...
                        //查询是否重复
                        meirongxiangmCollectionService.insertBatch(meirongxiangmCollectionList);
                        return R.ok();
                    }
                }
            }
    ...
    */
    @RequestMapping("/add")
    public R add(@RequestBody MeirongxiangmCollectionEntity meirongxiangmCollection, HttpServletRequest request){
        logger.debug("add方法:,,Controller:{},,meirongxiangmCollection:{}",this.getClass().getName(),meirongxiangmCollection.toString());
        Wrapper<MeirongxiangmCollectionEntity> queryWrapper = new EntityWrapper<MeirongxiangmCollectionEntity>()
            .eq("meirongxiangm_id", meirongxiangmCollection.getMeirongxiangmId())
            .eq("yonghu_id", meirongxiangmCollection.getYonghuId())
            .eq("meirongxiangm_collection_types", meirongxiangmCollection.getMeirongxiangmCollectionTypes())
//            .notIn("meirongxiangm_collection_types", new Integer[]{102})
            ;
        logger.info("sql语句:"+queryWrapper.getSqlSegment());
        MeirongxiangmCollectionEntity meirongxiangmCollectionEntity = meirongxiangmCollectionService.selectOne(queryWrapper);
        if(meirongxiangmCollectionEntity==null){
