...
, "usersId"});//把级联的数据添加到view中,并排除id和创建时间字段,当前表的级联注册表
            ...
            //级联表 美容师
            //级联表
            MeirongshiEntity meirongshi = meirongshiService.selectById(forum.getMeirongshiId());
            if(meirongshi != null){
    ...
    */
    ...
    public R save(@RequestBody ForumEntity forum, HttpServletRequest request){
        ...
        if(false)
            ...
            forum.setMeirongshiId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        ...
        Wrapper<ForumEntity> queryWrapper = new EntityWrapper<ForumEntity>()
            ...
            .eq("meirongshi_id", forum.getMeirongshiId())
...
//                            forumEntity.setMeirongshiId(Integer.valueOf(data.get(0)));   //美容师 要改的
