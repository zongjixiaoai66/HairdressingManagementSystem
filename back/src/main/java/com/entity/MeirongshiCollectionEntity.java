...
public class MeirongshiCollectionEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public MeirongshiCollectionEntity() {

	}

	public MeirongshiCollectionEntity(T t) {
		try {
    ...
    @TableField(value = "meirongshi_collection_types")
