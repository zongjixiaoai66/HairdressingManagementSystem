...
public class MeirongshiLiuyanView extends MeirongshiLiuyanEntity implements Serializable {
	...
	public MeirongshiLiuyanView() {

	}

	public MeirongshiLiuyanView(MeirongshiLiuyanEntity meirongshiLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, meirongshiLiuyanEntity);
