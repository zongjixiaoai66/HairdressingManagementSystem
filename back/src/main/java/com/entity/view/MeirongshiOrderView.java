...
public class MeirongshiOrderView extends MeirongshiOrderEntity implements Serializable {
	...
	*/
	...
	private String meirongshiOrderValue;
	/**
	* 支付类型的值
	*/
	@ColumnInfo(comment="支付类型的字典表值",type="varchar(200)")
	private String meirongshiOrderPaymentValue;
	...
	public MeirongshiOrderView() {

	}

	public MeirongshiOrderView(MeirongshiOrderEntity meirongshiOrderEntity) {
		try {
			BeanUtils.copyProperties(this, meirongshiOrderEntity);
	...
	* 获取： 订单类型的值
	*/
	public String getMeirongshiOrderValue() {
		return meirongshiOrderValue;
	}
	/**
	* 设置： 订单类型的值
	*/
	public void setMeirongshiOrderValue(String meirongshiOrderValue) {
		this.meirongshiOrderValue = meirongshiOrderValue;
	}
	//当前表的
	/**
	* 获取： 支付类型的值
	*/
	public String getMeirongshiOrderPaymentValue() {
		return meirongshiOrderPaymentValue;
	}
	/**
	* 设置： 支付类型的值
	*/
	public void setMeirongshiOrderPaymentValue(String meirongshiOrderPaymentValue) {
		this.meirongshiOrderPaymentValue = meirongshiOrderPaymentValue;
	}
	...
	public String toString() {
		return "MeirongshiOrderView{" +
			", meirongshiOrderValue=" + meirongshiOrderValue +
			", meirongshiOrderPaymentValue=" + meirongshiOrderPaymentValue +
