...
public class MeirongxiangmOrderView extends MeirongxiangmOrderEntity implements Serializable {
	...
	*/
	...
	private String meirongxiangmOrderValue;
	/**
	* 支付类型的值
	*/
	@ColumnInfo(comment="支付类型的字典表值",type="varchar(200)")
	private String meirongxiangmOrderPaymentValue;
	...
	public MeirongxiangmOrderView() {

	}

	public MeirongxiangmOrderView(MeirongxiangmOrderEntity meirongxiangmOrderEntity) {
		try {
			BeanUtils.copyProperties(this, meirongxiangmOrderEntity);
	...
	* 获取： 订单类型的值
	*/
	public String getMeirongxiangmOrderValue() {
		return meirongxiangmOrderValue;
	}
	/**
	* 设置： 订单类型的值
	*/
	public void setMeirongxiangmOrderValue(String meirongxiangmOrderValue) {
		this.meirongxiangmOrderValue = meirongxiangmOrderValue;
	}
	//当前表的
	/**
	* 获取： 支付类型的值
	*/
	public String getMeirongxiangmOrderPaymentValue() {
		return meirongxiangmOrderPaymentValue;
	}
	/**
	* 设置： 支付类型的值
	*/
	public void setMeirongxiangmOrderPaymentValue(String meirongxiangmOrderPaymentValue) {
		this.meirongxiangmOrderPaymentValue = meirongxiangmOrderPaymentValue;
	}
	...
	public String toString() {
		return "MeirongxiangmOrderView{" +
			", meirongxiangmOrderValue=" + meirongxiangmOrderValue +
			", meirongxiangmOrderPaymentValue=" + meirongxiangmOrderPaymentValue +
