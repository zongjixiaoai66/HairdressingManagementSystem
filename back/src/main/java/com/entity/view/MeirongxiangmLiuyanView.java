...
public class MeirongxiangmLiuyanView extends MeirongxiangmLiuyanEntity implements Serializable {
	...
	public MeirongxiangmLiuyanView() {

	}

	public MeirongxiangmLiuyanView(MeirongxiangmLiuyanEntity meirongxiangmLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, meirongxiangmLiuyanEntity);
	...
	public String toString() {
		return "MeirongxiangmLiuyanView{" +
