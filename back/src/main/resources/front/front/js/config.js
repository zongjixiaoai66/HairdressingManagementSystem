...
var centerMenu = [
    ...
    ,{
        name: '美容师收藏',
        url: '../meirongshiCollection/list.html'
    }
    ,{
        name: '美容师预约',
        url: '../meirongshiOrder/list.html'
    }
    ,{
        name: '美容项目收藏',
        url: '../meirongxiangmCollection/list.html'
    }
    ,{
        name: '美容项目订单',
        url: '../meirongxiangmOrder/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '美容师',
        url: './pages/meirongshi/list.html'
    },
    {
        name: '美容项目',
        url: './pages/meirongxiangm/list.html'
    },
    {
        name: '公告通知',
...
// 已废弃,不用了
var adminurl =  "http://localhost:8080/meifaguanli/admin/dist/index.html#/login";
